...
knitr::include_graphics("./figs/instalacion_Rstudio1.mov")
```
...
knitr::include_graphics("./figs/instalacion_Rstudio2.mov")
```
...
knitr::include_graphics("./figs/instalacion_Rstudio3.mov")
```
